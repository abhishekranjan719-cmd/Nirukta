...
Provides consistent, colorful, and structured logging across the engine service.
"""
...
def setup_logger():
    """
    Configure loguru logger with settings from engine.yaml
    ...
    logger.info(f"Engine logger initialized | Mode: {settings.mode} | Level: {log_level}")
